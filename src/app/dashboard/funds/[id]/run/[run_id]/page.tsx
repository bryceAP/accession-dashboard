...
export default function RunDetailPage() {
  ...
  return (
    <div style={{ background: '#0D0D0D', minHeight: '100vh' }}>
      ...
      {/* Breadcrumb */}
      <div
        className={`${mono.className} flex items-center gap-2 px-8 py-5`}
          ...
          {sections ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
              ...
              <div style={{ borderTop: '1px solid #1e1e1e', paddingTop: 20 }}>
                ...
                >
                  This report has been generated by Accession Partners using proprietary analysis tools and
                  AI-assisted research. The information contained herein is provided for informational purposes
                  only and does not constitute investment advice. Past performance is not indicative of future
                  results. All data is sourced from fund documents provided at the time of analysis. Accession
                  Partners makes no representations or warranties as to the accuracy or completeness of the
